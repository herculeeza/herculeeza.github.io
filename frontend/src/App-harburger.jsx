          ...
          {aboutOpen && (
            <div className="px-6 pb-8 max-w-2xl mx-auto text-gray-700 space-y-5">
              <p className="text-sm leading-relaxed">
                <strong>HARBURGER</strong> is a rare implementation of Harberger taxation—an idea from economist Arnold Harberger in 1965, popularized by Weyl & Posner's <em>Radical Markets</em>.
